...
public class HelloOSS {
    ...
    private static String bucketName = "appmusic";
    ...
    public static void main(String[] args) {
        ...
        PropertyConfigurator.configure("D:\\IdeaProjects\\springboot-music\\springboot-aliyunoss\\src\\main\\resources\\log4j.properties");
        ...
        try {
            ...
            /*InputStream is = new ByteArrayInputStream("D:\\BaiduNetdiskDownload\\黄家驹-海阔天空.mp3".getBytes());
...
*/
           ...
           /* OSSObject ossObject = ossClient.getObject(bucketName, firstKey);
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "盗将行";
            ossClient.putObject(bucketName, fileKey, new File("D:\\BaiduNetdiskDownload\\盗将行.mp3"));
